...
export function TeamSection() {
  ...
  return (
    <div id="team" className="py-20 bg-gradient-to-br from-blue-50/50 via-purple-50/50 to-indigo-50/50 dark:from-blue-950/10 dark:via-purple-950/10 dark:to-indigo-950/10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <Badge variant="outline" className="mb-4 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-purple-500/20">
            Our Team
          </Badge>
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Meet the Minds Behind <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">the Innovation</span>
          </h2>
        ...
        <div className='w-full md:max-w-4xl mx-auto mb-14'>
              ...
              <Card key={index} className="group hover:shadow-xl transition-all duration-500 border-0 bg-gradient-to-br from-white/80 to-white/60 dark:from-gray-900/80 dark:to-gray-800/60 backdrop-blur-sm hover:-translate-y-2">
                <CardContent className="p-6">
                  <div className="text-center mb-4">
                    <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-indigo-500/10 rounded-2xl p-8 backdrop-blur-sm border border-blue-500/20">
