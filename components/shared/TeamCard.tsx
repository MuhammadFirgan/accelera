...
const TeamCard = () => {
  return (
    ...
    <div className="relative w-44 md:w-52 flex flex-col items-center p-5  bg-zinc-100 dark:bg-zinc-900 rounded-lg transform transition duration-300 ">
        <div className="absolute inset-0 z-[-1] rounded-lg bg-gradient-to-tr from-blue-600 to-purple-600 blur-md opacity-75"></div>
        
        <div className="w-40 h-56 md:w-48 md:h-64 relative rounded-lg overflow-hidden z-0">
            <Image
                src="/images/team.jpg"
                alt="team photo"
                layout="fill"
        ...
        <h3 className="mt-4 text-primary text-xl font-bold">Firgan</h3>
    </div>
  );
};
